...
impl cudaError {
    ...
    pub const cudaErrorContained: cudaError = cudaError(226);
}
impl cudaError {
...
impl cudaError {
    ...
    pub const cudaErrorTensorMemoryLeak: cudaError = cudaError(721);
}
impl cudaError {
...
impl cudaChannelFormatKind {
    ...
    pub const cudaChannelFormatKindUnsignedNormalized1010102: cudaChannelFormatKind =
...
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaClusterSchedulingPolicy(pub ::std::os::raw::c_int);
...
impl cudaDeviceAttr {
    ...
    pub const cudaDevAttrGpuPciDeviceId: cudaDeviceAttr = cudaDeviceAttr(139);
}
impl cudaDeviceAttr {
    #[doc = "< The combined 16-bit PCI subsystem ID and 16-bit PCI subsystem vendor ID."]
    pub const cudaDevAttrGpuPciSubsystemId: cudaDeviceAttr = cudaDeviceAttr(140);
}
impl cudaDeviceAttr {
    #[doc = "< Device supports HostNuma location IPC between nodes in a multi-node system."]
    pub const cudaDevAttrHostNumaMultinodeIpcSupported: cudaDeviceAttr = cudaDeviceAttr(143);
}
impl cudaDeviceAttr {
    pub const cudaDevAttrMax: cudaDeviceAttr = cudaDeviceAttr(144);
}
#[repr(transparent)]
...
impl cudaMemcpySrcAccessOrder {
    #[doc = " Default invalid."]
    pub const cudaMemcpySrcAccessOrderInvalid: cudaMemcpySrcAccessOrder =
        cudaMemcpySrcAccessOrder(0);
}
impl cudaMemcpySrcAccessOrder {
    #[doc = " Indicates that access to the source pointer must be in stream order."]
    pub const cudaMemcpySrcAccessOrderStream: cudaMemcpySrcAccessOrder =
        cudaMemcpySrcAccessOrder(1);
}
impl cudaMemcpySrcAccessOrder {
    ...
    pub const cudaMemcpySrcAccessOrderDuringApiCall: cudaMemcpySrcAccessOrder =
        cudaMemcpySrcAccessOrder(2);
}
impl cudaMemcpySrcAccessOrder {
    ...
    pub const cudaMemcpySrcAccessOrderAny: cudaMemcpySrcAccessOrder = cudaMemcpySrcAccessOrder(3);
}
impl cudaMemcpySrcAccessOrder {
    #[doc = " Indicates that access to the source pointer can be out of stream order and the accesses\n can happen even after the API call returns. This flag is suited for host pointers\n allocated outside CUDA (ex., via malloc) when it's known that no prior operations\n in the stream can be accessing the memory. Specifying this flag allows the driver\n to optimize the copy on certain platforms."]
    pub const cudaMemcpySrcAccessOrderMax: cudaMemcpySrcAccessOrder =
        cudaMemcpySrcAccessOrder(2147483647);
}
#[repr(transparent)]
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaMemcpySrcAccessOrder(pub ::std::os::raw::c_int);
...
impl cudaMemcpy3DOperandType {
    #[doc = "< Memcpy operand is a valid pointer."]
    pub const cudaMemcpyOperandTypePointer: cudaMemcpy3DOperandType = cudaMemcpy3DOperandType(1);
}
impl cudaMemcpy3DOperandType {
    #[doc = "< Memcpy operand is a CUarray."]
    pub const cudaMemcpyOperandTypeArray: cudaMemcpy3DOperandType = cudaMemcpy3DOperandType(2);
}
impl cudaMemcpy3DOperandType {
    pub const cudaMemcpyOperandTypeMax: cudaMemcpy3DOperandType =
        cudaMemcpy3DOperandType(2147483647);
}
#[repr(transparent)]
#[doc = " These flags allow applications to convey the operand type for individual copies specified in ::cudaMemcpy3DBatchAsync."]
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaMemcpy3DOperandType(pub ::std::os::raw::c_int);
...
impl cudaJitOption {
    ...
    pub const cudaJitMaxRegisters: cudaJitOption = cudaJitOption(0);
}
impl cudaJitOption {
...
impl cudaJitOption {
    ...
    pub const cudaJitFallbackStrategy: cudaJitOption = cudaJitOption(10);
}
impl cudaJitOption {
    #[doc = " Specifies whether to create debug information in output (-g)\n (0: false, default)\\n\n Option type: int\\n\n Applies to: compiler and linker"]
    pub const cudaJitGenerateDebugInfo: cudaJitOption = cudaJitOption(11);
}
impl cudaJitOption {
    #[doc = " Generate verbose log messages (0: false, default)\\n\n Option type: int\\n\n Applies to: compiler and linker"]
    pub const cudaJitLogVerbose: cudaJitOption = cudaJitOption(12);
}
impl cudaJitOption {
    #[doc = " Generate line number information (-lineinfo) (0: false, default)\\n\n Option type: int\\n\n Applies to: compiler only"]
    pub const cudaJitGenerateLineInfo: cudaJitOption = cudaJitOption(13);
}
impl cudaJitOption {
    ...
    pub const cudaJitCacheMode: cudaJitOption = cudaJitOption(14);
}
impl cudaJitOption {
    #[doc = " Generate position independent code (0: false)\\n\n Option type: int\\n\n Applies to: compiler only"]
    pub const cudaJitPositionIndependentCode: cudaJitOption = cudaJitOption(30);
}
impl cudaJitOption {
    ...
    pub const cudaJitMinCtaPerSm: cudaJitOption = cudaJitOption(31);
}
impl cudaJitOption {
    ...
    pub const cudaJitMaxThreadsPerBlock: cudaJitOption = cudaJitOption(32);
}
impl cudaJitOption {
    ...
    pub const cudaJitOverrideDirectiveValues: cudaJitOption = cudaJitOption(33);
}
#[repr(transparent)]
#[doc = " Online compiler and linker options"]
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaJitOption(pub ::std::os::raw::c_int);
impl cudaLibraryOption {
    pub const cudaLibraryHostUniversalFunctionAndDataTable: cudaLibraryOption =
        cudaLibraryOption(0);
}
impl cudaLibraryOption {
    ...
    pub const cudaLibraryBinaryIsPreserved: cudaLibraryOption = cudaLibraryOption(1);
}
#[repr(transparent)]
#[doc = " Library options to be specified with ::cudaLibraryLoadData() or ::cudaLibraryLoadFromFile()"]
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaLibraryOption(pub ::std::os::raw::c_int);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct CUlib_st {
    _unused: [u8; 0],
...
impl cudaGraphConditionalNodeType {
    ...
    pub const cudaGraphCondTypeSwitch: cudaGraphConditionalNodeType =
        cudaGraphConditionalNodeType(2);
}
#[repr(transparent)]
#[doc = " CUDA conditional node types"]
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaGraphConditionalNodeType(pub ::std::os::raw::c_int);
...
impl cudaGraphInstantiateResult {
    ...
    pub const cudaGraphInstantiateConditionalHandleUnused: cudaGraphInstantiateResult =
        cudaGraphInstantiateResult(5);
}
#[repr(transparent)]
#[doc = " Graph instantiation results"]
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaGraphInstantiateResult(pub ::std::os::raw::c_int);
...
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaDriverEntryPointQueryResult(pub ::std::os::raw::c_int);
...
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaLaunchMemSyncDomain(pub ::std::os::raw::c_int);
...
impl cudaLaunchAttributeID {
    ...
    pub const cudaLaunchAttributePreferredClusterDimension: cudaLaunchAttributeID =
...
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaLaunchAttributeID(pub ::std::os::raw::c_int);
...
#[derive(Copy, Clone, Hash, PartialEq, Eq)]
pub struct cudaAsyncNotificationType_enum(pub ::std::os::raw::c_int);
#[doc = " Types of async notification that can occur"]
...
#[no_mangle]
pub extern "system" fn cudaDeviceReset() -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaDeviceSetLimit(limit: cudaLimit, value: usize) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaDeviceGetLimit(pValue: *mut usize, limit: cudaLimit) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaDeviceGetCacheConfig(pCacheConfig: *mut cudaFuncCache) -> cudaError_t {
    crate::unsupported()
}
...
pub unsafe extern "system" fn cudaDeviceGetStreamPriorityRange(
    ...
    crate::device_get_stream_priority_range(leastPriority, greatestPriority)
}
...
#[no_mangle]
pub extern "system" fn cudaDeviceSetCacheConfig(cacheConfig: cudaFuncCache) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaDeviceGetByPCIBusId(
...
#[no_mangle]
pub extern "system" fn cudaDeviceGetPCIBusId(
...
#[no_mangle]
pub extern "system" fn cudaIpcGetEventHandle(
...
#[no_mangle]
pub extern "system" fn cudaIpcOpenEventHandle(
...
#[no_mangle]
pub extern "system" fn cudaIpcGetMemHandle(
...
#[no_mangle]
pub extern "system" fn cudaIpcOpenMemHandle(
...
#[no_mangle]
pub extern "system" fn cudaIpcCloseMemHandle(devPtr: *mut ::std::os::raw::c_void) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaDeviceRegisterAsyncNotification(
    device: ::std::os::raw::c_int,
...
#[no_mangle]
pub extern "system" fn cudaDeviceUnregisterAsyncNotification(
    device: ::std::os::raw::c_int,
...
#[no_mangle]
pub extern "system" fn cudaDeviceGetSharedMemConfig(
...
#[no_mangle]
pub extern "system" fn cudaDeviceSetSharedMemConfig(config: cudaSharedMemConfig) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaPeekAtLastError() -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaGetErrorName(error: cudaError_t) -> *const ::std::os::raw::c_char {
    unimplemented!()
}
...
#[no_mangle]
pub unsafe extern "system" fn cudaGetErrorString(
    error: cudaError_t,
...
#[no_mangle]
pub unsafe extern "system" fn cudaGetDeviceProperties_v2(
    prop: *mut cudaDeviceProp,
    device: ::std::os::raw::c_int,
) -> cudaError_t {
    crate::get_device_properties(prop, device)
}
...
#[no_mangle]
pub extern "system" fn cudaInitDevice(
    device: ::std::os::raw::c_int,
...
#[no_mangle]
pub extern "system" fn cudaSetDeviceFlags(flags: ::std::os::raw::c_uint) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaGetDeviceFlags(flags: *mut ::std::os::raw::c_uint) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaStreamCreate(pStream: *mut cudaStream_t) -> cudaError_t {
    crate::unsupported()
}
...
pub unsafe extern "system" fn cudaStreamCreateWithPriority(
    ...
    crate::stream_create_with_priority(pStream, flags, priority)
}
...
#[no_mangle]
pub extern "system" fn cudaStreamGetPriority(
...
#[no_mangle]
pub extern "system" fn cudaStreamGetId(
    hStream: cudaStream_t,
...
#[no_mangle]
pub extern "system" fn cudaStreamGetDevice(
    hStream: cudaStream_t,
    device: *mut ::std::os::raw::c_int,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaStreamDestroy(stream: cudaStream_t) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaStreamAddCallback(
    stream: cudaStream_t,
...
#[no_mangle]
pub extern "system" fn cudaStreamAttachMemAsync(
    stream: cudaStream_t,
    devPtr: *mut ::std::os::raw::c_void,
    length: usize,
    flags: ::std::os::raw::c_uint,
...
#[no_mangle]
pub extern "system" fn cudaStreamBeginCaptureToGraph(
    stream: cudaStream_t,
    graph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaThreadExchangeStreamCaptureMode(
...
#[no_mangle]
pub extern "system" fn cudaStreamEndCapture(
    stream: cudaStream_t,
...
#[no_mangle]
pub extern "system" fn cudaStreamGetCaptureInfo_v3(
    stream: cudaStream_t,
    captureStatus_out: *mut cudaStreamCaptureStatus,
    id_out: *mut ::std::os::raw::c_ulonglong,
    graph_out: *mut cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaStreamUpdateCaptureDependencies(
    stream: cudaStream_t,
...
#[no_mangle]
pub extern "system" fn cudaStreamUpdateCaptureDependencies_v2(
    stream: cudaStream_t,
    dependencies: *mut cudaGraphNode_t,
    dependencyData: *const cudaGraphEdgeData,
    numDependencies: usize,
...
#[no_mangle]
pub unsafe extern "system" fn cudaEventRecord(
    event: cudaEvent_t,
    stream: cudaStream_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaEventElapsedTime_v2(
    ms: *mut f32,
    start: cudaEvent_t,
    end: cudaEvent_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaImportExternalMemory(
...
#[no_mangle]
pub extern "system" fn cudaImportExternalSemaphore(
...
#[no_mangle]
pub extern "system" fn cudaWaitExternalSemaphoresAsync_v2(
    extSemArray: *const cudaExternalSemaphore_t,
...
pub unsafe extern "system" fn cudaLaunchKernel(
    ...
    crate::launch_kernel(func, gridDim, blockDim, args, sharedMem, stream)
}
...
#[no_mangle]
pub extern "system" fn cudaLaunchCooperativeKernelMultiDevice(
...
#[no_mangle]
pub extern "system" fn cudaFuncGetName(
...
#[no_mangle]
pub extern "system" fn cudaFuncGetParamInfo(
    func: *const ::std::os::raw::c_void,
    paramIndex: usize,
...
#[no_mangle]
pub extern "system" fn cudaOccupancyMaxActiveBlocksPerMultiprocessor(
...
#[no_mangle]
pub extern "system" fn cudaOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(
    numBlocks: *mut ::std::os::raw::c_int,
    func: *const ::std::os::raw::c_void,
    blockSize: ::std::os::raw::c_int,
    dynamicSMemSize: usize,
...
#[no_mangle]
pub extern "system" fn cudaMallocManaged(
    devPtr: *mut *mut ::std::os::raw::c_void,
    size: usize,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaMallocPitch(
    devPtr: *mut *mut ::std::os::raw::c_void,
    pitch: *mut usize,
    width: usize,
    height: usize,
...
#[no_mangle]
pub extern "system" fn cudaMallocArray(
...
#[no_mangle]
pub extern "system" fn cudaFreeHost(ptr: *mut ::std::os::raw::c_void) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaFreeArray(array: cudaArray_t) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaHostAlloc(
...
#[no_mangle]
pub extern "system" fn cudaHostRegister(
...
#[no_mangle]
pub extern "system" fn cudaHostUnregister(ptr: *mut ::std::os::raw::c_void) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaHostGetDevicePointer(
...
#[no_mangle]
pub extern "system" fn cudaHostGetFlags(
...
#[no_mangle]
pub extern "system" fn cudaMalloc3D(
...
#[no_mangle]
pub extern "system" fn cudaMalloc3DArray(
    array: *mut cudaArray_t,
    desc: *const cudaChannelFormatDesc,
    extent: cudaExtent,
    flags: ::std::os::raw::c_uint,
...
#[no_mangle]
pub extern "system" fn cudaMallocMipmappedArray(
...
pub unsafe extern "system" fn cudaMemcpy(
    ...
    crate::memcpy(dst, src, count, kind)
}
...
#[no_mangle]
pub extern "system" fn cudaMemcpyPeer(
    dst: *mut ::std::os::raw::c_void,
    dstDevice: ::std::os::raw::c_int,
    src: *const ::std::os::raw::c_void,
    srcDevice: ::std::os::raw::c_int,
...
#[no_mangle]
pub extern "system" fn cudaMemcpy2D(
    dst: *mut ::std::os::raw::c_void,
    dpitch: usize,
    src: *const ::std::os::raw::c_void,
    spitch: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemcpy2DArrayToArray(
    dst: cudaArray_t,
    wOffsetDst: usize,
    hOffsetDst: usize,
    src: cudaArray_const_t,
...
#[no_mangle]
pub extern "system" fn cudaMemcpyFromSymbol(
    dst: *mut ::std::os::raw::c_void,
    symbol: *const ::std::os::raw::c_void,
    count: usize,
    offset: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemcpyBatchAsync(
...
#[no_mangle]
pub extern "system" fn cudaMemcpy3DBatchAsync(
    numOps: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemcpy2DAsync(
    dst: *mut ::std::os::raw::c_void,
    dpitch: usize,
    src: *const ::std::os::raw::c_void,
    spitch: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemcpy2DFromArrayAsync(
    dst: *mut ::std::os::raw::c_void,
    dpitch: usize,
    src: cudaArray_const_t,
    wOffset: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemset(
    devPtr: *mut ::std::os::raw::c_void,
    value: ::std::os::raw::c_int,
    count: usize,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaMemset2D(
    devPtr: *mut ::std::os::raw::c_void,
    pitch: usize,
    value: ::std::os::raw::c_int,
    width: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemset2DAsync(
    devPtr: *mut ::std::os::raw::c_void,
    pitch: usize,
    value: ::std::os::raw::c_int,
    width: usize,
...
#[no_mangle]
pub extern "system" fn cudaGetSymbolAddress(
    devPtr: *mut *mut ::std::os::raw::c_void,
    symbol: *const ::std::os::raw::c_void,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGetSymbolSize(
    size: *mut usize,
    symbol: *const ::std::os::raw::c_void,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaMemPrefetchAsync_v2(
    devPtr: *const ::std::os::raw::c_void,
    count: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemAdvise(
    devPtr: *const ::std::os::raw::c_void,
    count: usize,
...
#[no_mangle]
pub extern "system" fn cudaMemAdvise_v2(
    devPtr: *const ::std::os::raw::c_void,
    count: usize,
    advice: cudaMemoryAdvise,
    location: cudaMemLocation,
...
#[no_mangle]
pub extern "system" fn cudaMemRangeGetAttribute(
...
#[no_mangle]
pub extern "system" fn cudaMemRangeGetAttributes(
...
#[no_mangle]
pub extern "system" fn cudaMemcpyToArray(
    dst: cudaArray_t,
    wOffset: usize,
    hOffset: usize,
    src: *const ::std::os::raw::c_void,
...
#[no_mangle]
pub extern "system" fn cudaMemcpyToArrayAsync(
    dst: cudaArray_t,
    wOffset: usize,
    hOffset: usize,
    src: *const ::std::os::raw::c_void,
...
#[no_mangle]
pub extern "system" fn cudaMallocAsync(
    devPtr: *mut *mut ::std::os::raw::c_void,
    size: usize,
    hStream: cudaStream_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaMemPoolTrimTo(
    memPool: cudaMemPool_t,
...
#[no_mangle]
pub extern "system" fn cudaMemPoolSetAttribute(
    memPool: cudaMemPool_t,
...
#[no_mangle]
pub extern "system" fn cudaMemPoolGetAttribute(
    memPool: cudaMemPool_t,
    attr: cudaMemPoolAttr,
    value: *mut ::std::os::raw::c_void,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaMemPoolSetAccess(
    memPool: cudaMemPool_t,
...
#[no_mangle]
pub extern "system" fn cudaMemPoolGetAccess(
...
#[no_mangle]
pub extern "system" fn cudaMemPoolCreate(
    memPool: *mut cudaMemPool_t,
...
#[no_mangle]
pub extern "system" fn cudaMemPoolDestroy(memPool: cudaMemPool_t) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaMemPoolExportToShareableHandle(
...
#[no_mangle]
pub extern "system" fn cudaMemPoolImportFromShareableHandle(
    memPool: *mut cudaMemPool_t,
    shareableHandle: *mut ::std::os::raw::c_void,
    handleType: cudaMemAllocationHandleType,
    flags: ::std::os::raw::c_uint,
...
#[no_mangle]
pub extern "system" fn cudaMemPoolExportPointer(
...
#[no_mangle]
pub extern "system" fn cudaMemPoolImportPointer(
    ptr: *mut *mut ::std::os::raw::c_void,
    memPool: cudaMemPool_t,
    exportData: *mut cudaMemPoolPtrExportData,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaPointerGetAttributes(
...
#[no_mangle]
pub extern "system" fn cudaDeviceCanAccessPeer(
...
#[no_mangle]
pub extern "system" fn cudaDeviceEnablePeerAccess(
    peerDevice: ::std::os::raw::c_int,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaDeviceDisablePeerAccess(
    peerDevice: ::std::os::raw::c_int,
) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaGraphicsUnregisterResource(
...
#[no_mangle]
pub extern "system" fn cudaGraphicsMapResources(
...
#[no_mangle]
pub extern "system" fn cudaGraphicsUnmapResources(
    count: ::std::os::raw::c_int,
    resources: *mut cudaGraphicsResource_t,
    stream: cudaStream_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphicsResourceGetMappedPointer(
    devPtr: *mut *mut ::std::os::raw::c_void,
    size: *mut usize,
    resource: cudaGraphicsResource_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphicsSubResourceGetMappedArray(
    array: *mut cudaArray_t,
    resource: cudaGraphicsResource_t,
...
#[no_mangle]
pub extern "system" fn cudaRuntimeGetVersion(
...
#[no_mangle]
pub extern "system" fn cudaGraphCreate(
    pGraph: *mut cudaGraph_t,
    flags: ::std::os::raw::c_uint,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphKernelNodeGetParams(
...
#[no_mangle]
pub extern "system" fn cudaGraphKernelNodeSetParams(
    node: cudaGraphNode_t,
    pNodeParams: *const cudaKernelNodeParams,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphKernelNodeCopyAttributes(
...
#[no_mangle]
pub extern "system" fn cudaGraphKernelNodeGetAttribute(
...
#[no_mangle]
pub extern "system" fn cudaGraphKernelNodeSetAttribute(
    hNode: cudaGraphNode_t,
    attr: cudaLaunchAttributeID,
    value: *const cudaLaunchAttributeValue,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphMemcpyNodeGetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemcpyNodeSetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemcpyNodeSetParamsToSymbol(
    node: cudaGraphNode_t,
    symbol: *const ::std::os::raw::c_void,
    src: *const ::std::os::raw::c_void,
    count: usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemcpyNodeSetParamsFromSymbol(
    node: cudaGraphNode_t,
    dst: *mut ::std::os::raw::c_void,
    symbol: *const ::std::os::raw::c_void,
    count: usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemcpyNodeSetParams1D(
    node: cudaGraphNode_t,
    dst: *mut ::std::os::raw::c_void,
    src: *const ::std::os::raw::c_void,
    count: usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphAddMemsetNode(
    pGraphNode: *mut cudaGraphNode_t,
    graph: cudaGraph_t,
    pDependencies: *const cudaGraphNode_t,
    numDependencies: usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemsetNodeGetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemsetNodeSetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphHostNodeGetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphHostNodeSetParams(
    node: cudaGraphNode_t,
    pNodeParams: *const cudaHostNodeParams,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphChildGraphNodeGetGraph(
    node: cudaGraphNode_t,
    pGraph: *mut cudaGraph_t,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphEventRecordNodeGetEvent(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphEventRecordNodeSetEvent(
    node: cudaGraphNode_t,
    event: cudaEvent_t,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphEventWaitNodeGetEvent(
    node: cudaGraphNode_t,
    event_out: *mut cudaEvent_t,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphEventWaitNodeSetEvent(
    node: cudaGraphNode_t,
    event: cudaEvent_t,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphMemAllocNodeGetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphMemFreeNodeGetParams(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphClone(
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeFindInClone(
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeGetType(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphGetNodes(
    graph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphGetRootNodes(
    graph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphGetEdges(
    graph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphGetEdges_v2(
    graph: cudaGraph_t,
    from: *mut cudaGraphNode_t,
    to: *mut cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeGetDependencies(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeGetDependencies_v2(
    node: cudaGraphNode_t,
    pDependencies: *mut cudaGraphNode_t,
    edgeData: *mut cudaGraphEdgeData,
    pNumDependencies: *mut usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeGetDependentNodes(
    node: cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeGetDependentNodes_v2(
    node: cudaGraphNode_t,
    pDependentNodes: *mut cudaGraphNode_t,
    edgeData: *mut cudaGraphEdgeData,
    pNumDependentNodes: *mut usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphAddDependencies_v2(
    graph: cudaGraph_t,
    from: *const cudaGraphNode_t,
    to: *const cudaGraphNode_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphRemoveDependencies(
    graph: cudaGraph_t,
    from: *const cudaGraphNode_t,
    to: *const cudaGraphNode_t,
    numDependencies: usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphRemoveDependencies_v2(
    graph: cudaGraph_t,
    from: *const cudaGraphNode_t,
    to: *const cudaGraphNode_t,
    edgeData: *const cudaGraphEdgeData,
...
#[no_mangle]
pub extern "system" fn cudaGraphDestroyNode(node: cudaGraphNode_t) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaGraphInstantiate(
...
#[no_mangle]
pub extern "system" fn cudaGraphInstantiateWithFlags(
    pGraphExec: *mut cudaGraphExec_t,
    graph: cudaGraph_t,
    flags: ::std::os::raw::c_ulonglong,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphInstantiateWithParams(
    pGraphExec: *mut cudaGraphExec_t,
    graph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphExecGetFlags(
...
#[no_mangle]
pub extern "system" fn cudaGraphExecKernelNodeSetParams(
...
#[no_mangle]
pub extern "system" fn cudaGraphExecMemcpyNodeSetParams(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: *const cudaMemcpy3DParms,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphExecMemcpyNodeSetParamsToSymbol(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    symbol: *const ::std::os::raw::c_void,
    src: *const ::std::os::raw::c_void,
...
#[no_mangle]
pub extern "system" fn cudaGraphExecMemcpyNodeSetParamsFromSymbol(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    dst: *mut ::std::os::raw::c_void,
    symbol: *const ::std::os::raw::c_void,
...
#[no_mangle]
pub extern "system" fn cudaGraphExecMemcpyNodeSetParams1D(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    dst: *mut ::std::os::raw::c_void,
    src: *const ::std::os::raw::c_void,
...
#[no_mangle]
pub extern "system" fn cudaGraphExecMemsetNodeSetParams(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: *const cudaMemsetParams,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphExecHostNodeSetParams(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    pNodeParams: *const cudaHostNodeParams,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphExecChildGraphNodeSetParams(
    hGraphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    childGraph: cudaGraph_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphExecEventRecordNodeSetEvent(
    hGraphExec: cudaGraphExec_t,
    hNode: cudaGraphNode_t,
    event: cudaEvent_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphExecEventWaitNodeSetEvent(
    hGraphExec: cudaGraphExec_t,
    hNode: cudaGraphNode_t,
    event: cudaEvent_t,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphExecUpdate(
    hGraphExec: cudaGraphExec_t,
    hGraph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaGraphUpload(
    graphExec: cudaGraphExec_t,
    stream: cudaStream_t,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphExecDestroy(graphExec: cudaGraphExec_t) -> cudaError_t {
    crate::unsupported()
}

#[doc = " \\brief Destroys a graph\n\n Destroys the graph specified by \\p graph, as well as all of its nodes.\n\n \\param graph - Graph to destroy\n\n \\return\n ::cudaSuccess,\n ::cudaErrorInvalidValue\n \\note_graph_thread_safety\n \\notefnerr\n \\note_init_rt\n \\note_callback\n \\note_destroy_ub\n\n \\sa\n ::cudaGraphCreate"]
#[no_mangle]
pub extern "system" fn cudaGraphDestroy(graph: cudaGraph_t) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaGraphDebugDotPrint(
    graph: cudaGraph_t,
...
#[no_mangle]
pub extern "system" fn cudaUserObjectCreate(
...
#[no_mangle]
pub extern "system" fn cudaUserObjectRetain(
...
#[no_mangle]
pub extern "system" fn cudaUserObjectRelease(
    object: cudaUserObject_t,
    count: ::std::os::raw::c_uint,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphRetainUserObject(
    graph: cudaGraph_t,
    object: cudaUserObject_t,
    count: ::std::os::raw::c_uint,
    flags: ::std::os::raw::c_uint,
...
#[no_mangle]
pub extern "system" fn cudaGraphReleaseUserObject(
    graph: cudaGraph_t,
    object: cudaUserObject_t,
    count: ::std::os::raw::c_uint,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphAddNode(
    pGraphNode: *mut cudaGraphNode_t,
    graph: cudaGraph_t,
    pDependencies: *const cudaGraphNode_t,
    numDependencies: usize,
...
#[no_mangle]
pub extern "system" fn cudaGraphAddNode_v2(
    pGraphNode: *mut cudaGraphNode_t,
    graph: cudaGraph_t,
    pDependencies: *const cudaGraphNode_t,
    dependencyData: *const cudaGraphEdgeData,
...
#[no_mangle]
pub extern "system" fn cudaGraphNodeSetParams(
    node: cudaGraphNode_t,
    nodeParams: *mut cudaGraphNodeParams,
) -> cudaError_t {
    crate::unsupported()
...
#[no_mangle]
pub extern "system" fn cudaGraphExecNodeSetParams(
    graphExec: cudaGraphExec_t,
    node: cudaGraphNode_t,
    nodeParams: *mut cudaGraphNodeParams,
) -> cudaError_t {
...
#[no_mangle]
pub extern "system" fn cudaGraphConditionalHandleCreate(
...
#[no_mangle]
pub extern "system" fn cudaGetDriverEntryPointByVersion(
    symbol: *const ::std::os::raw::c_char,
    funcPtr: *mut *mut ::std::os::raw::c_void,
...
#[no_mangle]
pub extern "system" fn cudaLibraryLoadData(
...
#[no_mangle]
pub extern "system" fn cudaLibraryLoadFromFile(
    library: *mut cudaLibrary_t,
...
#[no_mangle]
pub extern "system" fn cudaLibraryUnload(library: cudaLibrary_t) -> cudaError_t {
    crate::unsupported()
}
...
#[no_mangle]
pub extern "system" fn cudaLibraryGetKernel(
...
#[no_mangle]
pub extern "system" fn cudaLibraryGetGlobal(
...
#[no_mangle]
pub extern "system" fn cudaLibraryGetManaged(
    dptr: *mut *mut ::std::os::raw::c_void,
    bytes: *mut usize,
    library: cudaLibrary_t,
    name: *const ::std::os::raw::c_char,
...
#[no_mangle]
pub extern "system" fn cudaLibraryGetUnifiedFunction(
...
#[no_mangle]
pub extern "system" fn cudaLibraryGetKernelCount(
...
#[no_mangle]
pub extern "system" fn cudaLibraryEnumerateKernels(
...
#[no_mangle]
pub extern "system" fn cudaKernelSetAttributeForDevice(
    kernel: cudaKernel_t,
    attr: cudaFuncAttribute,
    value: ::std::os::raw::c_int,
    device: ::std::os::raw::c_int,
...
#[no_mangle]
pub extern "system" fn cudaGetKernel(
